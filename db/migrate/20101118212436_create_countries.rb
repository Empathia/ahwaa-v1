class CreateCountries < ActiveRecord::Migration
  def self.up
    ...
    "libya", "morocco", "oman", "qatar", "saudi_arabia", "ethiopia", "sudan_republic", "south_sudan", "western_sahara", "syrian", "tunisia", "turkey", "united_arab_emirates", "yemen", "pakistan", "other"]
