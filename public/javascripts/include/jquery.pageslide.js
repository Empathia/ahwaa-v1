$.fn.pageSlide = function(opts) {
  ...
  function _openSlide(elm) {
    ...
    var dependantWidgets = [].slice.call(document.querySelectorAll('[data-pageslide]'), 0);
    dependantWidgets.forEach(function(widget) {
        widget.setAttribute('data-pageslide', 'open');
    });
  ...
  collection.bind('closePageSlide', function(event){
    ...
    var dependantWidgets = [].slice.call(document.querySelectorAll('[data-pageslide]'), 0);
    dependantWidgets.forEach(function(widget) {
        widget.setAttribute('data-pageslide', 'closed');
    });
  ...
  $("#pageslide-blanket").click(function(ev) {
